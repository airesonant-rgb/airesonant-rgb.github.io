...
<link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&fam<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body { font-family: 'DM Sans', sans-serif; background: #FAF8F5; color: #1A1208; overflow-x: hidden; line-height: 1.6; }
  ...
  .nav-logo { font-family: 'Syne', sans-serif; font-size: 22px; font-weight: 800; letter-spacing: -0.5px; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  .nav-links { display: flex; gap: 36px; list-style: none; }
  .nav-links a { text-decoration: none; color: #8A7E72; font-size: 14px; font-weight: 500; transition: color .2s; }
  .nav-links a:hover { color: #1A1208; }
  .nav-cta { background: #1A1208; color: #FAF8F5; padding: 10px 22px; border-radius: 100px; font-size: 14px; font-weight: 600; text-decoration: none; transition: all .2s; border: none; cursor: pointer; }
  .nav-cta:hover { background: #FF4D6D; transform: translateY(-1px); }
  ...
  .hero-badge { display: inline-flex; align-items: center; gap: 8px; background: #FFFFFF; border: 1px solid rgba(255,77,109,0.2); padding: 6px 16px; border-radius: 100px; font-size: 13px; font-weight: 500; color: #FF4D6D; margin-bottom: 32px; box-shadow: 0 2px 16px rgba(255,77,109,0.1); }
  .badge-dot { width: 6px; height: 6px; background: #FF4D6D; border-radius: 50%; animation: pulse-dot 2s ease-in-out infinite; }
  ...
  .hero h1 .outline-text { -webkit-text-stroke: 2px #1A1208; color: transparent; }
  .hero-sub { font-size: 19px; color: #8A7E72; font-weight: 400; max-width: 580px; margin: 24px auto 48px; line-height: 1.65; }
  .hero-ctas { display: flex; gap: 14px; justify-content: center; flex-wrap: wrap; }
  .btn-primary { background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; padding: 16px 36px; border-radius: 100px; font-size: 16px; font-weight: 600; text-decoration: none; transition: all .25s; border: none; cursor: pointer; box-shadow: 0 8px 32px rgba(255,77,109,0.3); display: inline-block; }
  .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 14px 40px rgba(255,77,109,0.4); }
  .btn-secondary { background: #FFFFFF; color: #1A1208; padding: 16px 36px; border-radius: 100px; font-size: 16px; font-weight: 600; text-decoration: none; border: 1.5px solid rgba(26,18,8,0.12); transition: all .25s; cursor: pointer; display: inline-block; }
  .btn-secondary:hover { border-color: #FF4D6D; color: #FF4D6D; transform: translateY(-2px); }
  .hero-stats { display: flex; gap: 48px; justify-content: center; margin-top: 64px; flex-wrap: wrap; }
  .stat { text-align: center; }
  .stat-num { font-family: 'Syne', sans-serif; font-size: 36px; font-weight: 800; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  .stat-label { font-size: 13px; color: #8A7E72; margin-top: 2px; }

  /* PHONE MOCKUP */
  .hero-phone { margin-top: 64px; position: relative; display: inline-block; }
  .phone-mockup { width: 280px; background: #1A1208; border-radius: 40px; padding: 16px; box-shadow: 0 40px 80px rgba(26,18,8,0.25); }
  .phone-notch { width: 80px; height: 24px; background: #1A1208; border-radius: 0 0 16px 16px; margin: 0 auto 16px; }
  .phone-screen { background: #F8F6F2; border-radius: 28px; padding: 20px; min-height: 360px; }
  .call-avatar { width: 72px; height: 72px; border-radius: 50%; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); margin: 16px auto 12px; display: flex; align-items: center; justify-content: center; font-size: 28px; }
  .call-name { font-family: 'Syne', sans-serif; font-size: 18px; font-weight: 800; color: #1A1208; text-align: center; }
  .call-status { font-size: 12px; color: #8A7E72; margin: 4px 0 16px; text-align: center; }
  .wave-bars { display: flex; gap: 4px; justify-content: center; align-items: flex-end; height: 36px; margin: 12px 0; }
  .wave-bar { width: 4px; border-radius: 4px; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); }
  ...
  .bubble.ai { background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; border-radius: 16px 16px 4px 16px; }
  .bubble.user { background: #EDEAE4; color: #1A1208; }

  /* SECTIONS */
  section { padding: 100px 60px; }
  .section-inner { max-width: 1100px; margin: 0 auto; }
  .section-tag { display: inline-block; font-size: 12px; text-transform: uppercase; letter-spacing: 2px; font-weight: 700; color: #FF4D6D; margin-bottom: 16px; }
  ...
  .section-title em { font-style: italic; color: #FF4D6D; }
  .section-sub { font-size: 18px; color: #8A7E72; max-width: 560px; line-height: 1.65; }

  /* LOGOS BAR */
  .logos-bar { background: #F0EDE8; padding: 28px 60px; border-top: 1px solid rgba(26,18,8,0.07); border-bottom: 1px solid rgba(26,18,8,0.07); }
  ...
  .logos-label { font-size: 12px; color: #8A7E72; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600; white-space: nowrap; }
  .logo-pill { background: #FFFFFF; border: 1px solid rgba(26,18,8,0.08); padding: 8px 20px; border-radius: 100px; font-size: 13px; font-weight: 600; color: #8A7E72; display: flex; align-items: center; gap: 8px; }

  /* PROBLEM */
  .problem { background: #1A1208; color: #FAF8F5; }
  .problem .section-title { color: #FAF8F5; }
  .problem .section-sub { color: #A89E94; }
  .problem .section-tag { color: #FF8096; }
  ...
  .problem-card::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 2px; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); }
  ...
  .problem-stat { margin-top: 24px; font-family: 'Syne', sans-serif; font-size: 36px; font-weight: 800; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .sol-card { background: #FFFFFF; border-radius: 24px; padding: 28px; box-shadow: 0 20px 60px rgba(26,18,8,0.08); border: 1px solid rgba(26,18,8,0.06); }
  .sol-step { display: flex; gap: 16px; align-items: flex-start; margin-bottom: 20px; }
  .sol-step:last-child { margin-bottom: 0; }
  .sol-dot { width: 40px; height: 40px; border-radius: 12px; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); display: flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0; }
  .sol-step-text h4 { font-family: 'Syne', sans-serif; font-size: 15px; font-weight: 700; margin-bottom: 4px; }
  .sol-step-text p { font-size: 13px; color: #8A7E72; line-height: 1.5; }
  ...
  .solution-list li::before { content: '✓'; width: 22px; height: 22px; border-radius: 50%; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; flex-shrink: 0; margin-top: 1px; }

  /* FEATURES */
  .features { background: #F0EDE8; }
  .features-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 60px; }
  .feat-card { background: #FFFFFF; border-radius: 20px; padding: 32px 28px; border: 1px solid rgba(26,18,8,0.06); transition: all .3s; }
  .feat-card:hover { transform: translateY(-4px); box-shadow: 0 20px 50px rgba(26,18,8,0.1); }
  .feat-card.highlight { background: #1A1208; color: #FAF8F5; border-color: transparent; }
  ...
  .feat-card p { font-size: 14px; color: #8A7E72; line-height: 1.65; }
  .feat-card.highlight p { color: #A89E94; }
  .feat-tag { display: inline-block; margin-top: 16px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .step-circle { width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); border: none; display: flex; align-items: center; justify-content: center; font-size: 28px; margin: 0 auto 24px; box-shadow: 0 8px 30px rgba(255,77,109,0.3); }
  .step-item h4 { font-family: 'Syne', sans-serif; font-size: 16px; font-weight: 700; margin-bottom: 8px; }
  .step-item p { font-size: 14px; color: #8A7E72; line-height: 1.5; }
  ...
  .benefit-row { display: flex; gap: 16px; align-items: flex-start; padding: 20px; border-radius: 16px; border: 1px solid rgba(26,18,8,0.07); background: #FFFFFF; transition: all .3s; }
  .benefit-row:hover { border-color: #FF4D6D; box-shadow: 0 8px 30px rgba(255,77,109,0.1); }
  ...
  .benefit-row p { font-size: 13px; color: #8A7E72; line-height: 1.5; }
  .metrics-card { background: #1A1208; color: #FAF8F5; border-radius: 24px; padding: 36px; }
  ...
  .metric-val { font-family: 'Syne', sans-serif; font-size: 20px; font-weight: 800; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }

  /* ─── ROADMAP ─── */
  .roadmap { background: #1A1208; color: #FAF8F5; padding: 100px 60px; }
  .roadmap .section-title { color: #FAF8F5; }
  .roadmap .section-sub { color: #A89E94; }
  .roadmap .section-tag { color: #FF8096; }
  ...
  .phase-node { width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 22px; flex-shrink: 0; border: 3px solid #1A1208; }
  .phase-node.live { background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); box-shadow: 0 0 0 6px rgba(255,77,109,0.2); }
  ...
  .phase-label.live-label { color: #FF8096; }
  .phase-label.soon-label { color: #FF9B3E; }
  ...
  .phase-features li { display: flex; gap: 10px; font-size: 14px; color: #FAF8F5; align-items: flex-start; }
  ...
  .badge-live { background: rgba(255,77,109,0.15); color: #FF8096; }
  .badge-soon { background: rgba(255,155,62,0.15); color: #FF9B3E; }
  ...
  .price-card-single { background: #1A1208; border-radius: 28px; padding: 48px; text-align: center; position: relative; overflow: hidden; box-shadow: 0 30px 80px rgba(26,18,8,0.2); }
  ...
  .early-badge { display: inline-block; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; font-size: 12px; font-weight: 700; padding: 6px 18px; border-radius: 100px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 24px; }
  .price-card-single h3 { font-family: 'Syne', sans-serif; font-size: 28px; font-weight: 800; color: #FAF8F5; margin-bottom: 8px; }
  .price-card-single .price-desc { font-size: 15px; color: #A89E94; margin-bottom: 32px; line-height: 1.6; }
  .big-price { font-family: 'Syne', sans-serif; font-size: 72px; font-weight: 800; line-height: 1; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .single-features li { display: flex; gap: 12px; font-size: 15px; color: #FAF8F5; align-items: flex-start; }
  .single-features li span:first-child { color: #FF8096; font-weight: 700; flex-shrink: 0; }
  .stripe-btn { display: block; width: 100%; text-align: center; padding: 20px; border-radius: 16px; font-size: 18px; font-weight: 700; text-decoration: none; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; box-shadow: 0 10px 40px rgba(255,77,109,0.4); transition: all .3s; border: none; cursor: pointer; font-family: 'DM Sans', sans-serif; }
  ...
  .price-access-note { background: rgba(255,77,109,0.1); border: 1px solid rgba(255,77,109,0.2); border-radius: 12px; padding: 16px; margin-top: 20px; font-size: 13px; color: #FF8096; line-height: 1.5; }

  /* DEMO */
  .demo { background: #1A1208; color: #FAF8F5; }
  ...
  .play-btn { width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); display: flex; align-items: center; justify-content: center; font-size: 28px; cursor: pointer; transition: all .3s; animation: ring 2s ease-in-out infinite; border: none; }
  ...
  .chat-msg.user { background: rgba(255,255,255,0.1); color: #FAF8F5; align-self: flex-start; border-radius: 16px 16px 16px 4px; }
  .chat-msg.ai { background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; align-self: flex-end; border-radius: 16px 16px 4px 16px; }
  ...
  .typing-dot { width: 6px; height: 6px; border-radius: 50%; background: #FF8096; animation: type-dot 1.2s ease-in-out infinite; }
  .typing-dot:nth-child(2){animation-delay:.2s}.typing-dot:nth-child(3){animation-delay:.4s}
  @keyframes type-dot { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-5px)} }

  /* TESTIMONIALS */
  .testimonials { background: #F0EDE8; }
  .testi-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 48px; }
  .testi-card { background: #FFFFFF; border-radius: 20px; padding: 32px 28px; border: 1px solid rgba(26,18,8,0.06); }
  .stars { color: #FF9B3E; font-size: 14px; margin-bottom: 16px; }
  ...
  .testi-avatar { width: 44px; height: 44px; border-radius: 50%; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); display: flex; align-items: center; justify-content: center; font-size: 18px; }
  .testi-name { font-family: 'Syne', sans-serif; font-size: 14px; font-weight: 700; }
  .testi-role { font-size: 12px; color: #8A7E72; }
  .testi-badge { display: inline-block; background: #E9D5FF; color: #6B21A8; font-size: 11px; font-weight: 700; padding: 4px 10px; border-radius: 100px; margin-top: 4px; text-transform: uppercase; letter-spacing: .5px; }

  /* FAQ */
  .faq-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 60px; }
  .faq-item { background: #FFFFFF; border-radius: 16px; padding: 28px; border: 1px solid rgba(26,18,8,0.06); cursor: pointer; transition: all .3s; }
  .faq-item:hover { border-color: #FF4D6D; }
  ...
  .faq-q::after { content: '+'; color: #FF4D6D; font-size: 20px; flex-shrink: 0; }
  .faq-a { font-size: 14px; color: #8A7E72; line-height: 1.65; }

  /* LEAD / SIGNUP */
  .lead { background: #FAF8F5; }
  .lead-box { background: #1A1208; border-radius: 32px; padding: 72px; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center; position: relative; overflow: hidden; }
  ...
  .lead-box .section-title { color: #FAF8F5; }
  .lead-box .section-sub { color: #A89E94; }
  .form-group { margin-bottom: 16px; }
  .form-input { width: 100%; padding: 16px 20px; background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.12); border-radius: 12px; color: #FAF8F5; font-size: 15px; font-family: 'DM Sans', sans-serif; transition: border-color .2s; outline: none; }
  .form-input::placeholder { color: #6B6057; }
  .form-input:focus { border-color: #FF4D6D; }
  .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
  .form-submit { width: 100%; margin-top: 8px; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); color: white; padding: 18px; border-radius: 12px; font-size: 16px; font-weight: 700; border: none; cursor: pointer; transition: all .25s; font-family: 'DM Sans', sans-serif; }
  ...
  .lead-features li { display: flex; gap: 12px; align-items: center; color: #FAF8F5; font-size: 15px; }

  /* FINAL CTA */
  .final-cta { background: #1A1208; padding: 120px 60px; text-align: center; }
  .final-cta .section-title { color: #FAF8F5; font-size: clamp(40px, 5vw, 72px); max-width: 700px; margin: 0 auto 24px; }
  ...
  /* INTEGRATIONS */
  .integrations { background: #F0EDE8; padding: 60px; }
  .int-inner { max-width: 1100px; margin: 0 auto; text-align: center; }
  .int-label { font-size: 13px; text-transform: uppercase; letter-spacing: 2px; color: #8A7E72; font-weight: 600; margin-bottom: 24px; }
  .int-grid { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; }
  .int-badge { background: #FFFFFF; border: 1px solid rgba(26,18,8,0.08); padding: 10px 20px; border-radius: 100px; font-size: 13px; font-weight: 600; color: #1A1208; display: flex; align-items: center; gap: 8px; }

  /* FOOTER */
  footer { background: #1A1208; color: #A89E94; padding: 60px; border-top: 1px solid rgba(255,255,255,0.06); }
  .footer-grid { max-width: 1100px; margin: 0 auto; display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 48px; }
  .footer-logo { font-family: 'Syne', sans-serif; font-size: 22px; font-weight: 800; background: linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin-bottom: 12px; }
  ...
  .footer-col h5 { font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 700; color: #FAF8F5; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 16px; }
  .footer-col ul { list-style: none; display: flex; flex-direction: column; gap: 10px; }
  .footer-col ul li a { color: #A89E94; text-decoration: none; font-size: 14px; transition: color .2s; }
  .footer-col ul li a:hover { color: #FAF8F5; }
...
<!-- SOLUTION -->
<section id="solution" style="background:#FAF8F5">
  <div class="section-inner">
...
<!-- HOW IT WORKS -->
<section id="how" style="background:#FAF8F5">
  <div class="section-inner">
    <div class="fade-up" style="text-align:center">
    ...
    <div class="benefits-layout">
      ...
      <div class="fade-up fade-up-delay-2">
        <div class="metrics-card">
          <div style="font-family:'Syne',sans-serif;font-size:16px;font-weight:700;color:#FAF8F5;margin-bottom:20px">📊 Pilot Restaurant Results</div>
  ...
  <div class="section-inner">
    <div class="demo-inner">
      <div class="fade-up">
        ...
        <h2 class="section-title" style="color:#FAF8F5">Hear Resoassit <em>in action</em></h2>
  ...
  <div class="section-inner">
    ...
    <div style="margin-top:72px;background:rgba(255,255,255,0.04);border-radius:20px;padding:32px 40px;border:1px solid rgba(255,255,255,0.08);display:flex;gap:0;flex-wrap:wrap;" class="fade-up">
      <div style="flex:1;min-width:200px;padding:16px 24px;border-right:1px solid rgba(255,255,255,0.08);text-align:center">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:14px;font-weight:700;color:#FAF8F5">AI Voice Agent</div>
        <div style="font-size:12px;color:#FF8096;margin-top:4px;font-weight:700">LIVE NOW</div>
      </div>
      <div style="flex:1;min-width:200px;padding:16px 24px;border-right:1px solid rgba(255,255,255,0.08);text-align:center">
        <div style="font-size:28px;margin-bottom:8px">🧑‍🍳</div>
        <div style="font-family:'Syne',sans-serif;font-size:14px;font-weight:700;color:#FAF8F5">Order Management</div>
        <div style="font-size:12px;color:#FF9B3E;margin-top:4px;font-weight:700">COMING SOON</div>
      </div>
      <div style="flex:1;min-width:200px;padding:16px 24px;border-right:1px solid rgba(255,255,255,0.08);text-align:center">
        <div style="font-size:28px;margin-bottom:8px">📦</div>
        <div style="font-family:'Syne',sans-serif;font-size:14px;font-weight:700;color:#FAF8F5">Logistics & Events</div>
      ...
      <div style="flex:1;min-width:200px;padding:16px 24px;text-align:center">
        <div style="font-size:28px;margin-bottom:8px">👥</div>
        <div style="font-family:'Syne',sans-serif;font-size:14px;font-weight:700;color:#FAF8F5">Payroll & Staff</div>
...
<section class="lead" id="signup">
  <div class="section-inner">
    <div class="lead-box">
      <div class="fade-up">
        <span class="section-tag" style="color:#FF8096">Get Early Access</span>
      ...
      <div class="fade-up fade-up-delay-2">
        ...
        <div id="form-success" style="display:none;text-align:center;padding:40px 20px">
          ...
          <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:#FAF8F5;margin-bottom:8px">You're in!</div>
          ...
          <div style="width:48px;height:4px;background:linear-gradient(135deg,#FF4D6D 0%,#FF9B3E 100%);border-radius:4px;margin:0 auto;animation:progress-bar 2s linear forwards"></div>
        </div>
        <!-- ERROR MESSAGE -->
        <div id="form-error" style="display:none;background:rgba(255,77,109,0.15);border:1px solid rgba(255,77,109,0.3);border-radius:12px;padding:14px 16px;font-size:14px;color:#FF8096;margin-bottom:16px">
        </div>
        <!-- THE FORM -->
        <div id="contact-form">
...
<section class="final-cta">
  <div class="fade-up">
    <span class="section-tag" style="color:#FF8096">Ready to Start?</span>
    ...
    <div class="final-ctas">
      ...
      <a href="#demo" class="btn-secondary" style="background:rgba(255,255,255,0.08);color:#FAF8F5;border-color:rgba(255,255,255,0.2)">Watch Live Demo</a>
    </div>
  </div>
</section>
...
</html>ily=DM+Sans:wght@300;400;500;600&family=Syne:wght@700;800&display=swap" rel="stylesheet">
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  :root {
    --cream: #FAF8F5;
